...
export function RegisterRoutes(router: KoaRouter) {
    ...
    // ###########################################################################################################
        router.post('/test',
            ...(fetchMiddlewares<Middleware>(TestController)),
            ...(fetchMiddlewares<Middleware>(TestController.prototype.test)),

            async function TestController_test(context: any, next: any) {
            const args = {
                    request: {"in":"body","name":"request","required":true,"ref":"Request"},
            };
